...
For the work on various research languages ([SOM], [SOMns], ...), I have
been using continuous performance tracking for the better part of the last decade.

One would hope that I would know what I are doing.

Since about half year, I am using [ReBenchDB] to track performance (before I used [Codespeed](https://github.com/tobami/codespeed)),
...
This analysis doesn't stand in a vacuum of course.
...
minimum and maximum for benchmarks at peak performance, which is interesting,
since the benchmarks used here seem to show higher differences.
They also provided JavaStat, a tool to automatically determine the necessary
...
They advocate of effect size confidence intervals as well as a visual approach
...
They suggest at the very least 10 invocations, but 15.
...
The propose an approach that carefully synchronizes the execution of the pairs
