...
<<control-flow-stats, cache=TRUE, fig.width=5, fig.height=2.6, fig.show='asis', strip.white=TRUE>>=
...
df <- subset(df, Benchmark %in% c("CD", "DeltaBlue", "Havlak", "Json", "Richards"))
...
<<alloc-and-access-stats, cache=TRUE, fig.width=5, fig.height=2.6, fig.show='asis', strip.white=TRUE>>=
...
\def\BasicOperations{%
<<basic-operations, cache=TRUE, fig.width=5, fig.height=2.8, fig.show='asis', strip.white=TRUE>>=
...
name_map <- list(
  ...
  "IntArith" = "bool, int: +, -, &, ^, !, <<, >>> (3)~~",
  "FltCmp" = "float: <, >, =, <=, !=, >= (4)",
  "FltArith" = "float: +, -, *, /, round (5)",
  "FltCplx"  = "float: sin, cos, sqrt (6)",
  "Length" = "str, arr: length (7)",
  "IntCplx"  = "int: *, /, %, rem (8)",
  "StrCmp" = "str: +, =, != (9)",
...
bo <- subset(bo, Benchmark %in% c("CD", "DeltaBlue", "Havlak", "Json", "Richards"))
